...
TITLE_KEYS = (
    "productname","title","g:title","name","product_name"
)

# ---- ITT BŐVÍTJÜK A LINK KULCSOKAT ----
LINK_KEYS  = (
    "url","link","g:link",
    "product_url","producturl","product-url",
    "product_link","productlink",
    "deeplink","deeplink_url","deeplinkurl",
    "aw_deep_link","awdeeplink"
)

# ---- ITT BŐVÍTJÜK A KÉP KULCSOKAT ----
IMG_KEYS   = (
    "imgurl","image_link","image","image_url","g:image_link","image1","main_image_url",
    "imageurl","img_url","img","product_image","productimage","product_image_url",
    "picture","picture_url","thumbnail","thumb","thumb_url","aw_image_url"
)
IMG_ALT_KEYS = (
    "imgurl_alternative","additional_image_link","additional_image_url",
    "images","image2","image3","extra_image","extra_image_link","gallery_image"
)

DESC_KEYS  = (
    "description","g:description","long_description","short_description","desc","popis"
)
...
COLOR_WORDS = (
    "fekete","fehér","feher","szürke","szurke","kék","kek","piros","zöld","zold",
...
def main():
    assert FEED_URL, "FEED_LAIFENSHOP_URL hiányzik (repo Secrets)."
