...
if not txt_files:
    raise SystemExit("Nincs .txt fájl a CJ Játék.net feedben :(")
...
with feed_file.open("r", encoding="utf-8", newline="") as f:
    ...
    for idx, row in enumerate(reader):
        ...
        sale_val, currency = parse_price(raw_sale, None)
        price_val, currency2 = parse_price(raw_price, currency)
        ...
        category = first_nonempty(row, "GOOGLE_PRODUCT_CATEGORY_NAME")
...
print(f"✅ CJ Játék.net kész: {total} termék, {pages} oldal.")
