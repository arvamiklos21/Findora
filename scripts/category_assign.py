...
ELECTRONICS = [
    "tv","televizio","monitor","laptop","tablet","telefon",
    "okostelefon","konzol","playstation","ps5","xbox",
    "hangfal","hangszoro","soundbar","headset","fulhallgato",
    "kamera","fenykepezo","router","nyomtato","projektor"
]

BOOKS = [
    "konyv","könyv","konyvek","regeny","roman","novella",
    "tankonyv","mesekonyv","gyerekkonyv","kepregeny"
]
...
def assign_category(partner_id: str, item: dict) -> str:
    ...
    if has(ELECTRONICS): return "kat-elektronika"
    if has(BOOKS): return "kat-konyv"
